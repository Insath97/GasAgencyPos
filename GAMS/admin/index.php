...
if (isset($_POST['login'])) {
  ...
  $stmt = $mysqli->prepare("SELECT admin_mail, admin_password, aadmin_id  FROM   rpos_aadmin WHERE (admin_mail =? AND admin_password =?)"); //sql to log in user
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white"> Blue Flame Gas Agency Management</h1>
            </div>
          </div>
        </div>
      </div>
