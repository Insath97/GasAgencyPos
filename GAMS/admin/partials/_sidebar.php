<?php
$admin_id = $_SESSION['aadmin_id'];
//$login_id = $_SESSION['login_id'];
$ret = "SELECT * FROM  rpos_aadmin  WHERE aadmin_id = '$admin_id'";
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php">
        <img src="assets/img/brand/INS.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="admin.php">
              <i class="fas fa-chess-king text-primary"></i> Admin
            </a>
          </li>
          <li class="nav-item">
