...
<head>
    ...
    <title>Blue Falame Gas Agency </title>
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/img/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/icons/icons8-coin-flame-32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/img/icons/icons8-coin-flame-16.png">
                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>Blue Falame Gas Agency </strong>
                                <br>
                                No:677/c V.H Road Sainthamaruthu - 14, Sainthamaruthu
                                <br>
                                Ampara,Sri lanka
                                <br>
                                (+94) 775062716
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">Lkr<?php echo $order->prod_price; ?></td>
                                    <td class="col-md-1 text-center">Lkr<?php echo $total; ?></td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                    ...
                                    <td class="text-center">
                                        <p>
                                            <strong>Lkr<?php echo $total; ?></strong>
                                        </p>
                                        <p>
                                            <strong>14%</strong>
                                        </p>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong>Lkr<?php echo $total; ?></strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
